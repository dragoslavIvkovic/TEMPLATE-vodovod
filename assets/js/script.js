...
/*------------------------------------------
    ...
    /*------------------------------------------
        = CONTACT FORM SUBMISSION (bez PHP / email)
    -------------------------------------------*/
    $("form.contact-validation-active").each(function () {
        $(this).validate({
            rules: {
                name: {
                    required: true,
            ...
            messages: {
                ...
                subject: "Izaberite temu."
            },
            submitHandler: function (form) {
                $("#loader", form).show();
                window.setTimeout(function () {
                    $("#loader", form).hide();
                    $("#success", form).slideDown("slow");
                    window.setTimeout(function () {
                        $("#success", form).slideUp("slow");
                    }, 2800);
                    form.reset();
                }, 650);
                return false;
